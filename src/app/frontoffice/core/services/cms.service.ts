...
export class CmsService {
  ...
  // ========== INVESTIGACIÓN (Control prenatal) ==========
  {
    ...
    readingTime: 5,
    emoji: '🤰',
    excerpt: 'El control prenatal regular reduce riesgos y asegura un embarazo saludable. Conoce las etapas y exámenes necesarios.',
    featured: false,
  },
  {
    id: 'cp-2',
    ...
    readingTime: 4,
    emoji: '🥗',
    excerpt: 'Una alimentación balanceada es clave para el desarrollo del bebé. Descubre qué nutrientes no pueden faltar.',
    featured: false,
  },
  ...
  // ========== TECNOLOGÍA (Ecografías) ==========
  {
    ...
    readingTime: 4,
    emoji: '👶',
    excerpt: 'Conoce los tipos de ecografía disponibles y en qué momento del embarazo se recomienda cada una.',
    featured: false,
  },
  {
    id: 'eco-2',
    ...
    readingTime: 5,
    emoji: '💓',
    excerpt: 'Esta ecografía especializada permite evaluar el flujo sanguíneo del bebé y detectar posibles complicaciones.',
    featured: false,
  },
  ...
  // ========== CULTURA (Parto humanizado) ==========
  {
    ...
    readingTime: 6,
    emoji: '🌸',
    excerpt: 'Un enfoque que prioriza el bienestar emocional y físico de la madre durante el trabajo de parto.',
    featured: false,
  },
  {
    id: 'ph-2',
    ...
    readingTime: 5,
    emoji: '📋',
    excerpt: 'Documenta tus deseos para el momento del parto: posiciones, acompañante, analgesia y más.',
    featured: false,
  },
  ...
  // ========== EVENTOS (Consultas y cuidados) ==========
  {
    ...
    readingTime: 5,
    emoji: '🚑',
    excerpt: 'Aprende a identificar las contracciones verdaderas y otros signos que indican que el parto se acerca.',
    featured: false,
  },
  {
    id: 'ev-2',
    ...
    readingTime: 4,
    emoji: '🛌',
    excerpt: 'Consejos para una recuperación saludable después del parto: alimentación, descanso y cuidados íntimos.',
    featured: false,
  },
  ...
  // ========== PROYECTOS (Especialistas y programas) ==========
  {
    ...
    readingTime: 4,
    emoji: '🤱',
    excerpt: 'La OMS recomienda lactancia exclusiva los primeros 6 meses. Conoce todos sus beneficios.',
    featured: false,
  },
  {
    id: 'py-2',
    ...
    readingTime: 5,
    emoji: '💚',
    excerpt: 'Apoyo psicológico especializado para madres durante el embarazo, parto y postparto.',
    featured: false,
  },
];
